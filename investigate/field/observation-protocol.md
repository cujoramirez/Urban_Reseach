...
> `SOURCE-INVENTORY.md`). The point of observing is to test these, including the chance they're
> wrong.
...
- **Pick paired segments:** a **main-corridor** segment (named street, e.g. a block of Jl.
  ...
  Kuningan / Setiabudi / Menteng Atas), observed **the same day, similar time**.
...
- [ ] ≥2 main-corridor segments **and** their paired back-streets
- [ ] The three named crowd nodes on the corridor: **Dukuh Atas / Stasiun Sudirman area**,
      **GBK–FX**, **Ratu Plaza / Menara Mandiri** \[S1, S11]
- [ ] At least one **day** and one **after-dark** pass of the same segment
- [ ] At least one **weekend/CFD** pass
- [ ] Both a **hot/dry** and (if possible) a **wet** observation
