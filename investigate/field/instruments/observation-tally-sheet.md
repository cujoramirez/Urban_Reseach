...
counts CSV ([data/README.md](../data/README.md)). Use **5-minute count windows**.

---

## Header
- Segment ID: ____________  Type: ☐ MAIN corridor  ☐ BACK-street   Pair ID: ________
- Named street: ______________________________  Side: ☐ N/E  ☐ S/W
- Observer(s): __________________  Date: __________  GPS pin: __________________
- Time window: ____:____ – ____:____ WIB
- Period: ☐ AM peak ☐ midday ☐ PM peak ☐ after-dark ☐ weekend/CFD
- Weather: ☐ hot/dry ☐ overcast ☐ rain   Temp/feel: ________
...
| Casual / student |  | | Men (est.) |  |
| Vendor (PKL) |  | | | |
| Ojol / courier |  | | Apparent age skew: | ☐ youth ☐ adult ☐ older |
| Parent + child |  | | | |
...
|  | crossed away from a crossing |  |  |
|  | clustered/waited (ojol/halte) |  |  |
|  | sought shade / changed side |  |  |
|  |  |  |  |
|  |  |  |  |
...
---
**Reminder:** a high *or* low road-walking count is data either way. Photograph the ordinary,
not only the problems. Blur faces (see [photos/README.md](../photos/README.md)).
