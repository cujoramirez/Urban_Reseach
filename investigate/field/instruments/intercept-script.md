...
> interaction that feels unsafe for you or the respondent.

---

## 1. Verbal consent (say this first, every time)

> "Halo, kami mahasiswa dari Apple Developer Academy. Kami sedang meneliti pengalaman
> berjalan kaki di area Sudirman. Boleh minta waktu sekitar 3–5 menit? Jawaban Anda anonim,
> tidak ada jawaban benar atau salah, dan Anda boleh berhenti kapan saja."

- Proceed only after the person agrees.
- If you want to record audio, **ask separately and explicitly** before recording
  (see [`../transcripts/README.md`](../transcripts/README.md)).

## 2. Warm-up

1. "Anda sedang dalam perjalanan ke mana, kalau boleh tahu?" *(purpose of trip)*
2. "Seberapa sering Anda berjalan kaki di area ini?" *(frequency)*
...
- Note: segment ID, approx. time, est. demographic (only if needed and observed, not asked
  intrusively), and anything notable. Log into the intercept transcript / data.
