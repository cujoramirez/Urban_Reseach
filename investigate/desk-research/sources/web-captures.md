# Web-source captures (non-PDF)

Provenance for sources that are web pages rather than downloadable PDFs. Each records the
URL, access date, and the **exact passages** the findings rest on. PDFs are stored as files
in this same `sources/` folder.
...
- **Accessed:** 2026-06-16
- **Official source quoted in article:** Hari Nugroho, Kepala Dinas Bina Marga DKI Jakarta
- **Exact passages (Indonesian):**
  - "sejak 2017 hingga 2019, revitalisasi trotoar di Ibukota tercatat telah dilakukan sepanjang 134 kilometer"
  - Sudirman–MH Thamrin sidewalk width: "antara 8-12 meter", completed 2018
  - 2019 program: 51 locations across five Jakarta municipalities; budget Rp 327 billion
  - 2020 target: 47 kilometers
- **Data type:** Quantitative + Policy. **Origin:** Government.
- **Scope tag:** Sudirman–Thamrin specific (widths) + broader DKI Jakarta (program totals = context).
...
- **Exact findings (from abstract):**
  - Method: Global Walkability Index (GWI), 9 parameters, pedestrian counts, segment length,
    survey + 25 pedestrian interviews.
  - Ranking: Jl. Medan Merdeka = "waiting to walk"; Jl. MH Thamrin & Jl. Jenderal Sudirman =
    "pleasure to walk".
  - Noted needs: reduce non-pedestrian activity, improve amenities, aesthetics, repair damaged
    sections.
- **Data type:** Quantitative (index). **Origin:** Academic.
- **Scope tag:** Corridor-specific (Thamrin–Sudirman axis). **NOTE:** 2015 study = a
  PRE-revitalization (pre-2018) baseline.
...
- **Accessed:** 2026-06-16
- **Attributes figures to:** BPS *Survei Komuter Jabodetabek 2023*
- **Exact figures:**
  - Private vehicles (going): "79,02%"; (returning): "77,93%"
  - Public transport (going): "19,52%"; (returning): "20,40%"
  - Walking/cycling: "tidak sampai 2%" (<2%), both directions
  - Separate note: "pada 2019, hampir 10% penduduk Jakarta adalah komuter"
- **Data type:** Quantitative. **Origin:** News/data (secondary; primary = BPS 2023).
- **Scope tag:** CONTEXT (Jabodetabek). Relevant to last-mile walking share.
- **VERIFY:** ideally confirm against BPS primary (Silastik) before heavy reliance.
...
- **Verified (org level, from About/Get-to-Know pages):** KCL is a Jakarta-focused urban lab;
  ...
  approach; acts as a delivery partner to Pemprov DKI.
...
- **Accessed:** 2026-06-16
- **What it is:** ITDP Indonesia's pedestrian-facility design guide, produced via technical
  assistance to Dinas Bina Marga DKI Jakarta; an update of the "NMT Vision & Guideline."
...
- **Exact figures — "2.1 DATA DAN FAKTA" (p. 7), with the guide's own source attributions:**
  ...
  - "1 Pedestrian tewas tiap 6 hari di Jakarta" (Ditlantas Polda Metro Jaya 2014)
  - "3513 langkah/hari rata-rata jumlah langkah orang Indonesia" (Stanford University)
  - ">125 micron/m3 kandungan partikel polusi udara di Jakarta Utara" (Desert Research Institute)
  - ">40% PNS DKI Jakarta mengalami obesitas" (DKI Jakarta Health Department)
  - QLUE #PedestrianFirst (1 Aug–5 Sep 2017): "643 laporan" of pedestrian-facility violations;
    "Jakarta Barat ... sebesar 31% dari total laporan."
...
- **Exact passages:**
  - "Trotoar hingga badan jalan kini dikuasai kendaraan tanpa pengendalian yang tegas"
  - "Trotoar dipenuhi kendaraan, badan jalan menyempit akibat parkir sembarangan"
- **Named location:** Jl. Matraman Raya (East Jakarta); Blok M (parking-revenue angle).
  **Does NOT mention Sudirman; does NOT cite a Dishub percentage.**
- **Data type:** Qualitative (SENT/context). **Origin:** News. **Scope:** CONTEXT (city-wide).
- **Use:** corroborates the *theme* of vehicle encroachment on sidewalks (cf. S1 on Sudirman
  seg. 4); not a corridor figure.
...
- **Corroboration:** a 2nd GoodStats article
  ...
  attributes the ~79% private / ~19% public / <2% walk+cycle split to **BPS Komuter Jabodetabek
...
- **Exact (verified):** "Kecelakaan yang melibatkan pejalan kaki saat menyeberang … mencapai
  8.274 di 2023." Top types: loss-of-control 18.961; rear-end 18.638; head-on 17.337.
- **Data type:** Quantitative. **Origin:** News/data (primary = Korlantas). **Scope:** CONTEXT.
