...
|----------------------|---------------------|--------|-----|
| "Do you use the sidewalk / walk in the road?" | our own **counts** (sidewalk vs road) at that segment | observation | n/a |
...
| What's still unsolved, and what would you prioritize? | (open) | n/a | n/a |
