...
Pribadi.* GoodStats Data. Figures attributed to **Badan Pusat Statistik (BPS), Survei Komuter
Jabodetabek 2023.**

- **URL:** https://data.goodstats.id/statistic/hampir-80-komuter-jabodetabek-memilih-gunakan-kendaraan-pribadi-k2igx
- **Primary source:** BPS, Statistik Komuter Jabodetabek 2023 (not yet pulled directly).
- **Capture:** `sources/web-captures.md` → CAP-3
- **Source type:** Data journalism (secondary) citing government statistics (primary).
- **Accessed:** 2026-06-16
...
## QUANTITATIVE findings (exact passages; attributed to BPS Komuter 2023)
- Private vehicles: **"79,02%"** (going) / **"77,93%"** (returning).
- Public transport: **"19,52%"** (going) / **"20,40%"** (returning).
- **Walking / cycling: "tidak sampai 2%"** (<2%) both directions.
- Separately: **"pada 2019, hampir 10% penduduk Jakarta adalah komuter."**
...
## Corridor vs. general
- Entirely metro-regional context. Do **not** present as a Sudirman figure.
