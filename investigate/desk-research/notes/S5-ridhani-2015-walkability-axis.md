...
Thamrin–Sudirman Jakarta* [Skripsi S1 Pembangunan Wilayah]. Universitas Gadjah Mada. (Advisor:
...
## Scope
**CORRIDOR-SPECIFIC** (Thamrin–Sudirman axis, plus Medan Merdeka to the north). **IMPORTANT:
2015 → this is a PRE-revitalization (pre-2018) BASELINE.** It describes the corridor *before*
the 2018–2020 works that S1/S4 describe.

## QUANTITATIVE findings (from abstract)
...
abstract page and is **contradicted by S9** (Mulyadi et al. 2022), a peer-reviewed paper that
...
## QUALITATIVE / SENTIMENT (from abstract)
- Even at the top ranking, improvements were needed in: non-pedestrian activity on the trotoar,
  amenities, aesthetics, and repair of damaged sections.

## Corridor vs. general
- Corridor-specific. The "pleasure to walk" rating is for the **main axis**, not back-streets.

## Flags
- **VERIFY:** abstract-level only. Do not cite numbers beyond what the abstract states; the GWI
  sub-scores per parameter are in the un-retrieved full text.
- **Temporal caveat:** as a 2015 baseline it is most useful to show *change over time* alongside
  S1/S4 (post-revitalization), not as current state.
