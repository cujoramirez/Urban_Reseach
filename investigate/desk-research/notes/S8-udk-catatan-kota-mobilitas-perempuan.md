...
yang Aman & Nyaman Untuknya?* Catatan Kota. Urun Daya Kota.

- **URL (listing):** https://www.urundayakota.org/catatankota
...
## QUANTITATIVE
- **None retrieved.** Do not attribute any statistic to UDK.

## Corridor vs. general
- General urban / women's-mobility framing only.

## Flags
- **GAP within source:** retrieve the full article (body, date, any data) before citing beyond
  the framing sentence. Logged in inventory (G5 remainder).
- Pair conceptually with S2 (KRPA: streets as top harassment site) when discussing the **safety
  dimension of comfort for women**, but keep each source's scope labels intact.
