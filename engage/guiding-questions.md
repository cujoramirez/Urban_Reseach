...
back to the walking experience in the Sudirman corridor.
...
5. **Who is walking, and for what purpose?** (e.g. commuting, ojek/ojol pickup, leisure,
   errands)
   - *Why this matters:* Comfort needs differ by who is walking and why. Keeps us from
...
## ⚠️ Callout: phrasings to avoid

> Do **not** write questions that assume the conclusion. For example, *"Where do pedestrians
> walk in the road **despite** a good sidewalk?"* pre-loads two conclusions (that the
> sidewalk is good, and that people avoid it anyway). It was split into the neutral pair
> **A1** and **A2** above. Keep this kind of leading phrasing out of the question list.
